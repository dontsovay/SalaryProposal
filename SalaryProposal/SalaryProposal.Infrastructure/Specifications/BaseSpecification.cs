...
namespace SalaryProposal.Infrastructure.Specifications
{
    ...
    /// <seealso cref="SalaryProposal.Infrastructure.Interfaces.ISpecification{T}" />
    public abstract class BaseSpecification<T> : ISpecification<T>
    {
        /// <summary>Initializes a new instance of the <see cref="BaseSpecification{T}"/> class.</summary>
        ...
        /// <summary>Gets the include strings.</summary>
        /// <value>The include strings.</value>
        public List<string> IncludeStrings { get; } = new List<string>();

        /// <summary>Adds the include.</summary>
